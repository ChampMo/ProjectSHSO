...
//-----------------------------------------------
// เลือก input และ container ที่มี .inproduct จะถูกเพิ่มลงไป
...
productCountInput.addEventListener('input', createProductElements);

// ฟังก์ชันสำหรับสร้าง .inproduct และรูปภาพตามจำนวนที่ผู้ใช้ป้อน
function createProductElements() {
    // รับจำนวน .inproduct จาก input
    const productCount = parseInt(productCountInput.value);

    // ลบ .inproduct ที่มีอยู่อย่างเดิม (ถ้ามี)
    productContainer.innerHTML = '';

    // สร้าง .inproduct และรูปภาพตามจำนวนที่ได้รับ
